...
export default function MyBookings() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "pending":
        return <Badge variant="secondary" className="bg-sport-orange text-white">Pending</Badge>;
      case "cancelled":
        return <Badge variant="destructive">Dibatalkan</Badge>;
      case "completed":
        return <Badge variant="outline" className="border-sport-blue text-sport-blue">Selesai</Badge>;
      default:
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Kelola dan pantau semua pemesanan lapangan Anda</p>
        </div>
            ...
            <CardContent className="p-12">
              <div className="text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">
                  {selectedTab === "all" ? "Belum ada pemesanan" : 
                   selectedTab === "upcoming" ? "Tidak ada pemesanan yang akan datang" :
                   selectedTab === "completed" ? "Belum ada pemesanan yang selesai" :
                   "Tidak ada pemesanan yang dibatalkan"}
                </h3>
                <p className="text-gray-500 mb-6">
                  {selectedTab === "all" ? "Mulai booking lapangan favorit Anda sekarang!" :
                ...
                <CardContent className="p-6">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
                    ...
                    <div className="flex flex-col md:flex-row md:items-start space-y-4 md:space-y-0 md:space-x-6 flex-1">
                      ...
                      <div className="w-full md:w-32 h-24 bg-gray-200 rounded-lg overflow-hidden">
                        <img
                          src={booking.facility?.images?.[0] || "https://images.unsplash.com/photo-1574629810360-7efbbe195018?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=400"}
                          alt={booking.facility?.name}
                          className="w-full h-full object-cover"
                          onError={(e) => {
                            e.currentTarget.src = "https://images.unsplash.com/photo-1574629810360-7efbbe195018?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=400";
                          }}
                        />
                      </div>
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-4 text-sm text-gray-600 mt-1">
                            <div className="flex items-center">
                              ...
                              {booking.business?.businessName || "Unknown Business"}
                            </div>
                            <div className="flex items-center">
                              <Users className="h-4 w-4 mr-1" />
                              {booking.facility?.sportType || "Unknown Sport"}
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    <div className="text-sm text-gray-600">
                      <span className="font-medium">Nama Pemesan:</span> {booking.customerName} • 
                      <span className="font-medium ml-2">Telepon:</span> {booking.customerPhone}
                      {booking.notes && (
                        <>
                          <br />
        ...
        <DialogContent>
          ...
          <div className="py-4">
            <p className="text-gray-600">
              ...
              <span className="font-medium">{selectedBooking?.facility?.name}</span> pada{" "}
              <span className="font-medium">
                {selectedBooking && new Date(selectedBooking.bookingDate).toLocaleDateString("id-ID")}
              </span>?
            </p>
            <p className="text-sm text-gray-500 mt-2">
              Pembatalan dapat dilakukan hingga 2 jam sebelum waktu booking.
            </p>
          </div>
          <DialogFooter>
            ...
            >
              {cancelBookingMutation.isPending ? "Membatalkan..." : "Ya, Batalkan"}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
