...
import { SearchFilters as SearchFiltersType, FacilityWithDetails } from "@/lib/types";
...
export default function CustomerHome() {
  ...
  const [selectedFacility, setSelectedFacility] = useState<FacilityWithDetails | null>(null);
            ...
            <div className="lg:w-3/4">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-semibold">
                  {isLoading ? "Mencari..." : `${facilities.length} Lapangan Ditemukan`}
                </h2>
                <Select>
                  ...
                  <SelectContent>
                    <SelectItem value="relevant">Urutkan: Relevan</SelectItem>
              ...
              {isLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <Button onClick={handleSearch} className="bg-sport-blue hover:bg-blue-700">
                    Cari Lagi
                  </Button>
                </div>
              ) : (
                <>
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    {facilities.map((facility: FacilityWithDetails) => (
                      <FacilityCard
                        key={facility.id}
                        facility={facility}
                  ...
                  <div className="flex justify-center mt-8">
                    <nav className="flex items-center space-x-2">
                      ...
                      <Button variant="default" size="sm" className="bg-sport-blue">
                        1
                      </Button>
